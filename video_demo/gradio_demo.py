...
def gradio_answer(video_path, chatbot, num_beams, temperature):
    ...
    response = agent.answer(
        video_path=video_path, prompt=chatbot[-1][0], max_new_tokens=200, num_beams=num_beams, temperature=temperature
    )
...
def main():
    with gr.Blocks(
        ...
        upload_button.click(upload_video, [up_video], [up_video, text_input, upload_button])
        ...
        clear.click(gradio_reset, [], [chatbot, up_video, text_input, upload_button], queue=False)
